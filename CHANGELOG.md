...
- **Remaining framework keyboard/focus and all dynamic-state/error fixtures:** the Flask and Angular ports plus every state/error case remain planned after the validated Static HTML, React, and Vue patterns.
