...
The public manifest is [benchmark/cases.json](../benchmark/cases.json). Each stack family receives semantics/name, keyboard/focus, and dynamic-state/error cases. Nine of the 15 frozen cases are implemented: semantics/name fixtures for Static, React, Vue, Angular, and Flask, plus the Static, React, Vue, and Flask keyboard/focus fixtures. The remaining Angular keyboard/focus case and all dynamic-state/error cases stay explicit pending work rather than being counted as completed results.
